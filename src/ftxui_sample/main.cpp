...
// configuration step. It creates a namespace called `first_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", first_template::cmake::project_name, first_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", first_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
